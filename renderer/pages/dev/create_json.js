...
export async function getStaticProps() {
  var obj = {
    buah: {
        show_name: "Buah",
        image_file: ["alpukat_2.png"],
    },
    hewan: {
      show_name: "Hewan",
      image_file: ["kucing_1.png"],
    },
    benda: {
      show_name: "Benda",
      image_file: ["spidol_1.png"],
    },
    kendaraan: {
      show_name: "Kendaraan",
      image_file: ["becak_1.png"],
    },
  };

  var json = JSON.stringify(obj);

  fs.writeFile("./database/category.json", json, "utf8", function (err) {
    if (err) throw err;
