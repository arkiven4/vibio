    ...
    <div className={(styles.container, stylesCustom.backgound_image)} style={{ backgroundImage: "url('/bg2.jpg')" }}>
      ...
      {isFinishQuiz ? (
        <main className={styles.main}>
          <CoachPop4 show={nowCoach == 4 ? true : false} nextFunction={nextCoach}></CoachPop4>
          ...
          <div className={nowCoach == 4 ? stylesCoach.finish_play_container_coach : stylesCustom.finish_play_container}>
        ...
        <>
          {quizData.length != 0 ? (
            <main className={styles.main}>
              ...
              <CoachPop3 show={nowCoach == 3 ? true : false} nextFunction={nextCoach}></CoachPop3>
              <div
              ...
              >
                <div className={nowCoach == 1 ? stylesCoach.card_option_coach : stylesCustom.card_option}>
                  <Image
                    onClick={() => {
                      playSound();
                    }}
              ...
              {enableRecog ? (
                <div className={nowCoach == 2 ? stylesCoach.button_container_coach : stylesCustom.button_container}>
                ...
                <div className={stylesCustom.button_container}>
                  <div className={nowCoach == 2 ? stylesCoach.button_image_subtitle_coach : stylesCustom.button_image_subtitle} onClick={() => selectOption(false)}>
                  ...
                  <div className={nowCoach == 3 ? stylesCoach.button_image_subtitle_coach : stylesCustom.button_image_subtitle} onClick={() => selectOption(true)}>
