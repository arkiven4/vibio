    ...
    <div className={(styles.container, stylesCustom.backgound_image)} style={{ backgroundImage: "url('/bg2.jpg')" }}>
      ...
      {isFinishQuiz ? (
        ...
        <CoachPop3 show={nowCoach == 3 ? true : false} nextFunction={nextCoach}></CoachPop3>
          ...
          <div className={nowCoach == 3 ? stylesCoach.finish_play_container_coach : stylesCustom.finish_play_container}>
        ...
        <>
          {quizData.length != 0 ? (
            <main className={styles.main}>
              <CoachPop2 show={(nowCoach == 2 && showOption) ? true : false} nextFunction={nextCoach}></CoachPop2>
              <CoachPop1 show={(nowCoach == 1 && !showOption) ? true : false} nextFunction={nextCoach}></CoachPop1>
              ...
              <div className={(nowCoach == 1 && !showOption) ? stylesCoach.general_coach : ""}>
              ...
              {quizOptionImage.length != 0 ? (
                <div className={(nowCoach == 2 && showOption) ? stylesCoach.general_coach : ""}>
