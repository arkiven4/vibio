          ...
          <div className={stylesCustom.finish_play_container}>
            <div className={stylesCustom.mini_card_vertical}>
              <h4 style={{ marginBottom: "0px", color: "green", textAlign: "center" }}>
                Benar: <br></br> {rightQuestion} / {QuestionNumber}
              </h4>
            </div>
            <div className={stylesCustom.mini_card_vertical}>
              <h4 style={{ marginBottom: "0px", color: "red", textAlign: "center" }}>
                Salah: <br></br> {QuestionNumber - rightQuestion} / {QuestionNumber}
              </h4>
            </div>
          </div>
          {isDoneSubmitData ? (
        ...
        <>
          {quizData.length != 0 ? (
            <main className={styles.main} style={{ paddingTop: "15px" }} id="tour_summary">
              <Walktour
                isOpen={indexTutorial == 0 ? true : false}
                steps={[
                  {
                    selector: "#tour_soal",
                    title: "Jumlah Soal",
                  ...
                  {
                    selector: "#tour_playbutton",
                    title: "Tombol Pemutar Suara",
                    description: "Anak akan mendengakan suara, kemudian memilih gambar berdasarkan suara, anda dapat mencobanya",
                    disableMaskInteraction: false,
                    disableSmoothScroll: true,
                    closeLabel: "Tutup",
              ...
              />
              <Walktour
                isOpen={indexTutorial == 1 ? true : false}
                steps={[
                  {
                    selector: "#tour_gambarcard",
                    title: "Pilihan Jawaban",
                    description: "Anak harus memilih gambar sesuai dengan suara yang telah didengar",
                    disableMaskInteraction: false,
                    disableClose: true,
                    disableSmoothScroll: true,
                    closeLabel: "",
                  ...
                  },
                  {
                    ...
                    disableSmoothScroll: true,
                    closeLabel: "Tutup",
                    customCloseFunc: finish_tutorial,
                  },
                ]}
              />
              ...
              {quizOptionImage.length != 0 ? (
                <div>
                  <div id="Options" ref={OptionsRef} className={showOption ? stylesCustom.fade_in : stylesCustom.fade_out}>
                    <br></br>
                    <div className="row mx-auto" id="tour_gambarcard">
