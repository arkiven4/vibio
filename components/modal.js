...
const LoginModalAnnouncement = (props) => {
  return (
    <motion.div
      initial={{
        opacity: 0,
...
const ModalCountdownASRQuiz = (props) => {
  var imageShowsrc = props.isSending ? "/assets/emoji_good.png" : "/assets/emoji_bad.png";
  return (
    <motion.div
      initial={{
        opacity: 0,
    ...
    >
      <motion.div className={stylesCustom.popup}>
        {props.isSending ? (
          <motion.h3 className={`${stylesCustom.mini_card_popupRW}`} style={{ color: "black", textAlign: 'center' }}>
            Memproses Data....
          </motion.h3>
        ) : (
          <motion.h3 className={`${stylesCustom.mini_card_popupRW}`} style={{ color: "black", textAlign: 'center' }}>
            ...
            <motion.div className={stylesCustom.popup_card}>
              ...
              >
                {props.isSending ? (
                  ...
                  <motion.h1 style={{ color: "black", fontSize: '5vh' }}>
                    {props.countdown}
                  </motion.h1>
                )}
              </motion.div>
...
module.exports = {
  ModalReactionQuiz,
  ModalAnnaouncement,
  LoginModalAnnouncement,
  ModalCountdownASRQuiz,
};
